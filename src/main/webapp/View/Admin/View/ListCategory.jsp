...
<div class="wrapper d-flex">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9"></div>
                <div class="col-md-3"><a style="float: right ; margin-top: 35px" class="btn btn-warning" href="/admin?ac=add_cate">Add new Category</a> </div>
            </div>
                ...
                <table style="margin-top: 50px ; color: black" class="table table-striped">
                    ...
                    <c:forEach items='${requestScope["categoryList"]}' var="category">
                        <tr>
                            ...
                            <td style="text-align: center">${category.getName()}</td>
                            <td style="text-align: center"><a class="btn btn-primary" href="/admin?ac=edit_cate&id=${category.getId()}">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a type="button" class="btn btn-danger" href="/admin?ac=delete_cate&id=${category.getId()}">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
